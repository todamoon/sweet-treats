...
<title>Sweet Treats - cupcakes</title>
...
<ul class="menu">
    ...
    <li id="cart"><a href="#">Logout</a></li>
    <li id="cart"><a href="#">Login</a></li><!--this link is SWAPPED WITH REGISTER-->
 	</ul>
</div>
<?php
require('config.php');
...
$result = mysql_query("SELECT * FROM catalog WHERE type = 'cupcake'") or die (mysql_error());
