...
<title>Sweet Treats - Brownie</title>
...
<ul class="menu">
    ...
    <li id="cart"><a href="register.php">Register</a></li><!--this link is SWAPPED WITH REGISTER-->
 	</ul>
</div>
<?php
require('config.php');
...
$result = mysql_query("SELECT * FROM catalog WHERE type = 'brownie'") or die (mysql_error());
echo "<table border='1'>";
...
while($row = mysql_fetch_array($result))
  {
    ...
    echo "<input type=hidden name='productid' value='$productName'></form>";
	echo "<input type=hidden name='productcost' value='$productCost'></form>";
	 "</th></tr>";
